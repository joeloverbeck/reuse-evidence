...
| **Decision surface** | The exact bounded choices presented for human acceptance, with the consequence each choice authorizes. A decision surface is not itself acceptance. |
