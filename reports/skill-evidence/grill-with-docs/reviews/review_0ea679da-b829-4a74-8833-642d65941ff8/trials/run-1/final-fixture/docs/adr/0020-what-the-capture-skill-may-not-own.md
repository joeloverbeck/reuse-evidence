...
**Amended:** 2026-08-13 by explicit maintainer acceptance. Capture may render and present a prepared proposal for human acceptance, but issue decomposition and implementation routing remain outside capture ownership. The decision and boundaries below are otherwise unchanged.
