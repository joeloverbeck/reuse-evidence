...
**Amended:** 2026-08-13 by explicit maintainer acceptance. Capture may render and present a prepared proposal for human acceptance. That presentation does not accept or publish the proposal, and it does not authorize capture to decompose the accepted work into issues or route implementation; issue decomposition and implementation routing remain outside capture ownership. The decision and status below are otherwise unchanged.
